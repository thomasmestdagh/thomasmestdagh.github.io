    ...
    <>
      <div className={styles.about}>
        ...
        <p className={styles.aboutParagraph}>
          ...
          great user experiences. Infusing web projects with elements of
          playfulness is my forte. My journey is marked by continuous learning
          and experimentation, driven by a desire to gamify the web. <br />
          Through personal projects, I&apos;ve honed my skills and cultivated a
          knack for problem-solving. I&apos;m looking forward to contribute my
          creativity and determination to your team. Let&apos;s embark on this
          journey together, shaping great digital experiences along the way.
        </p>
      </div>
